...
/*!
* @class TIM3xx
* @brief Class responsible for communicating with TIM3xx device.
*
* @author Konrad Banachowicz
*/
...
public:
	...
	/*!
	* @brief Connect to TIM3xx.
	* @param host TIM3xx host name or ip address.
	* @param port TIM3xx port number.
	*/
	void connect(std::string host, int port = 2111);

	/*!
	* @brief Disconnect from TIM3xx device.
	*/
	void disconnect();
	...
	* After receiving this command TIM3xx unit starts spinning laser and measuring.
	*/
	void startMeas();

	/*!
	* @brief Stop measurements.
	* After receiving this command TIM3xx unit stop spinning laser and measuring.
	*/
	void stopMeas();

	/*!
	* @brief Get current status of TIM3xx device.
	* @returns status of TIM3xx device.
	*/
	status_t queryStatus();

	/*!
	* @brief Log into TIM3xx unit.
